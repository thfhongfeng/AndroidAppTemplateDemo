...
public class AdvanceDecoration extends RecyclerView.ItemDecoration {
    ...
    public AdvanceDecoration(Context context, int dividerResId, int dividerWidth, int orientation) {
        this(context, context.getResources().getDrawable(dividerResId), dividerWidth, orientation);
    }

    public AdvanceDecoration(Context context, Drawable divider, int dividerWidth, int orientation) {
