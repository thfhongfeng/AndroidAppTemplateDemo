package com.pine.demo.recyclerview;
...
//                if (mRecyclerView.getTag(IS_INIT) == null) {
                if (mRecyclerView.getTag(R.id.rv_tag_is_init) == null) {
                    // 设置固定大小
...
//                mRecyclerView.setTag(INIT_STATE, IS_INIT);
                mRecyclerView.setTag(R.id.rv_tag_is_init, IS_INIT);
            }
        });
        ...
        horizontalBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                hideAllRecyclerView();
                if (mHorRecyclerView.getTag(R.id.rv_tag_is_init) == null) {
                    // 设置固定大小
                    ...
                    AdvanceRecyclerAdapter advanceRecyclerAdapter =
                            new AdvanceRecyclerAdapter(RecyclerViewActivity.this,
                                    R.layout.item_recycler_layout_wrap, mTitle, mItemClickListener);
                ...
                mHorRecyclerView.setTag(R.id.rv_tag_is_init, IS_INIT);
            }
        });
        ...
        gridBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                hideAllRecyclerView();
                if (mGridRecyclerView.getTag(R.id.rv_tag_is_init) == null) {
                    // 设置固定大小
                    ...
                    AdvanceRecyclerAdapter advanceRecyclerAdapter =
                            new AdvanceRecyclerAdapter(RecyclerViewActivity.this,
                                    R.layout.item_recycler_layout_match, mTitle, mItemClickListener);
                ...
                mGridRecyclerView.setTag(R.id.rv_tag_is_init, IS_INIT);
            }
        });
        ...
        staggeredBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                hideAllRecyclerView();
                if (mStaggeredRecyclerView.getTag(R.id.rv_tag_is_init) == null) {
                    // 设置固定大小
                ...
                mStaggeredRecyclerView.setTag(R.id.rv_tag_is_init, IS_INIT);
            }
        });
        ...
        decorBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                hideAllRecyclerView();
                if (mDecorRecyclerView.getTag(R.id.rv_tag_is_init) == null) {
                    // 设置固定大小
                ...
                mDecorRecyclerView.setTag(R.id.rv_tag_is_init, IS_INIT);
            }
        });
        ...
        advanceDecorBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                hideAllRecyclerView();
                if (mAdvanceDecorRecyclerView.getTag(R.id.rv_tag_is_init) == null) {
                    // 设置固定大小
                    ...
                    mAdvanceDecorRecyclerView.addItemDecoration(
                            new AdvanceDecoration(RecyclerViewActivity.this,
                                    R.drawable.rv_divider, 3, AdvanceDecoration.VERTICAL));
                    // 添加默认的动画效果
                ...
                mAdvanceDecorRecyclerView.setTag(R.id.rv_tag_is_init, IS_INIT);
            }
        });
