...
public class CustomConsoleContainer extends LinearLayout {
    ...
    private final int[] mAllImageItems = {
            R.drawable.cv_fire, R.drawable.cv_computer, R.drawable.cv_tree, R.drawable.cv_star,
            R.drawable.cv_phone, R.drawable.cv_pad
    };
    ...
    private void init(AttributeSet attrs, int defStyle) {
        TypedArray typedArray =
                mContext.obtainStyledAttributes(attrs, R.styleable.CustomConsoleContainerCV);

        if (typedArray != null) {
            mConsoleMode = typedArray
                    .getInt(R.styleable.CustomConsoleContainerCV_consoleMode, TEXT_MODE);
            mScrollOrientaion = typedArray.getInt(
                    R.styleable.CustomConsoleContainerCV_scrollOrientation, SCROLL_X);
        }
        LayoutInflater.from(mContext).inflate(
                R.layout.custom_console_container, this, true);
    ...
    private void setupScrollOrientation() {
        ...
        LayoutInflater.from(mContext).inflate(
                mScrollOrientaion == SCROLL_X && mConsoleMode == IMAGE_MODE ?
                        R.layout.custom_horizontal_console_container :
                        R.layout.custom_vertical_console_container, mConsoleContainerLL, true);
